...
- [x] **Define Termux Configuration Management Spec**
...
- [x] **Move Existing Termux Configurations**
...
- [x] **Validate Changes with `chezmoi diff`**
...
- [x] **Apply Changes with `chezmoi apply`**
